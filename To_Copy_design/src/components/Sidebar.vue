<template>
  <!-- Sidebar -->
  <div
    class="fixed inset-y-0 z-50 w-64 glass-effect shadow-2xl transform transition-all duration-300 ease-in-out border-l border-secondary-200/50 dark:border-secondary-700/50"
